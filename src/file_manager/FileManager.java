...
public class FileManager {
    ...
    // Provides icons and names for files.
        ...
        if (gui==null) {
            ...
            TreeSelectionListener treeSelectionListener = new TreeSelectionListener() {
                public void valueChanged(final TreeSelectionEvent tse){
                    ...
                    //create new thread by non freeze interface
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    URL urlBig = fileManager.getClass().getResource("images.closeFolder.png");
                    URL urlSmall = fileManager.getClass().getResource("images/openFolder.png");
